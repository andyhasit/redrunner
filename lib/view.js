...
var View = /*#__PURE__*/function () {
  function View(parent, props, seq) {
    ...
    _defineProperty(this, "__html__", '<div/>');
  ...
  _createClass(View, [{
    ...
    value: function __gw(path) {
      ...
      */
      var el = path.reduce(function (accumulator, index) {
        return accumulator.childNodes[index];
      }, this.root.e);
      return new _utils.Wrapper(el, this);
    }
  }, {
    key: "__un",
    value: function __un() {
      this.__nv.forEach(function (child) {
        if (child.__ia()) {
          child.update();
        }
      });
    ...
    value: function __uw() {
       ...
       */
      var path, newValue, previousValue, callbacks;
    ...
    key: "__ia",
    value: function __ia() {
      var el = this; // TODO: loop until parent
      // let element = 
